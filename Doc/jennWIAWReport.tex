...
\begin{center}
	...
	\begin{tabular}{|l|l|}
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0x9134db20eb2d6f07.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0x53090ffede18f1b8.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0xc3298ff8d8003028.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0xc3090fe89c10f098.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0xdb410f50dc59f1ba.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0xd1410f70dc59f0ac.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0xdb400f50dc50f13a.png}}
		& \\
		...
		& \\
		\hline
		\multirow{5}{*}{\includegraphics[width = .12\textwidth]{0xd2410ef0d859f4be.png}}
		& \\
...
\begin{figure}[h!!t]
	\begin{center}
		\includegraphics[width = .45\textwidth]{0x9134db20eb2d6f07.png}
		\includegraphics[width = .45\textwidth]{0x53090ffede18f1b8.png}\\
		\vspace{2mm}
		\includegraphics[width = .45\textwidth]{0xc3298ff8d8003028.png}
		\includegraphics[width = .45\textwidth]{0xc3090fe89c10f098.png}\\
		\vspace{2mm}
		\includegraphics[width = .45\textwidth]{0xdb410f50dc59f1ba.png}
		\includegraphics[width = .45\textwidth]{0xd1410f70dc59f0ac.png}
		\vspace{2mm}
		\includegraphics[width = .45\textwidth]{0xdb400f50dc50f13a.png}
		\includegraphics[width = .45\textwidth]{0xd2410ef0d859f4be.png}
	\end{center}

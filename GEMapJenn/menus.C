...
// Miguel ->
void saveScore(double);
void saveParams(int *, char **);
// <- Miguel
...
*/
RootMenu::RootMenu (int *_argc, char **_argv)
    : Menu(root_message, Helv18, SCREEN_BORDER, 1-SCREEN_BORDER, false), argc(_argc), argv(_argv)
// <- Miguel
{
...
// Miguel ->
//void RootMenu::open ()
void RootMenu::open (int *argc, char **argv)
// <- Miguel
{
    // Miguel ->
    //if (not RootMenu::s_unique_instance) new RootMenu();
    if (not RootMenu::s_unique_instance) new RootMenu(argc, argv);
    // <- Miguel
}
void RootMenu::_call (int N)
{
	...
	// Miguel ->
        ...
        case 10:saveParams(argc, argv);	break;
        case 12:saveScore(1); exit(0);	break;
        case 13:saveScore(2); exit(0);	break;
        case 14:saveScore(3); exit(0);	break;
        case 15:saveScore(4); exit(0);	break;
        case 16:saveScore(5); exit(0);	break;
        case 17:saveScore(-1);exit(0);	break;
	// <- Miguel
#else
...
void saveParams(int *argc, char **argv){
	std::ofstream outF("bestparams.txt", std::ios::app);
